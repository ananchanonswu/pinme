...
- คุณภาพของการทดสอบ : ประสบความสำเร็จในการทำ Automated Unit Test ด้วย Jest โดยสามารถทำ Statement Coverage ได้สูงถึง 97.33% ซึ่งสะท้อนให้เห็นว่าทีมใส่ใจกับคุณภาพของโค้ด
